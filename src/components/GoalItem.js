...
function GoalItem({ goal, onDelete, onUpdate }) {
  ...
  return (
    <div className={`card mb-3 ${isCompleted ? 'border-success' : isOverdue ? 'border-danger' : isWarning ? 'border-warning' : ''}`}>
              ...
              <div className="col-md-6">
                ...
                <p className="mb-1">
                  ...
                  {isCompleted ? (
                    ...
                    <span className="text-warning">Urgent ({daysRemaining} days left)</span>
                  ) : (
